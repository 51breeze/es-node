...
const {AssertionError:AssertionError2,AssertionError} = require("node:assert");
...
const {constants:constantsFs} = require("node:fs");
const fs = require("node:fs");
const {BlockList,connect} = require("node:net");
